...
INSERT INTO public.services VALUES (4, 'other');
...
SELECT pg_catalog.setval('public.appointments_appointment_id_seq', 518, true);
...
SELECT pg_catalog.setval('public.customers_customer_id_seq', 468, true);
